...
public class MostrarMedico extends JDialog {
	...
	public static void main(String[] args) {
		try {
			MostrarMedico dialog = new MostrarMedico();
	...
	public MostrarMedico() {
		...
		Object[] columnNames = {"Cód. Médico", "Cédula", "Nombre", "Sexo", "Teléfono", "Dirección", "Especialidad"};
		Object[][] data = {
				{"M-1", "402-567385-05", "Sarah", "F", "829-423-2554", false, "Cirujana"},
		};
